...
<body>
    ...
    <div style="text-align:center; height: 126px;">
        ...
        <asp:TextBox ID="UserNameTextLogin" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="PasswordLogin" runat="server" Text="密码："></asp:Label>
        <asp:TextBox ID="PasswordTextLogin" runat="server"></asp:TextBox>
        <br />
        <br />
        <asp:Button ID="LoginButton" runat="server" Text="登陆" OnClick="Button1_Click" />
        &nbsp; &nbsp;
        <asp:Button ID="RegisterButtonLogin" runat="server" Text="注册" />
    </div>
    </form>
</body>
</html>
